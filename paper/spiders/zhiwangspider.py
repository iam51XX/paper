...
class ZhiwangspiderSpider(scrapy.Spider):
    ...
    cookies = {
        'Hm_lvt_2e552fbaf5e9c8ff5d407c2048cc91bb': '1743141536,1743239525,1744121077,1744667039',
        'Hm_lpvt_2e552fbaf5e9c8ff5d407c2048cc91bb': '1744667039',
        'HMACCOUNT': 'FC9D3909A3EBF658',
        'wengine_vpn_ticketwebvpn_shmtu_edu_cn': 'eb30edc2df560c41',
        'show_vpn': '1',
        'heartbeat': '1',
        'show_faq': '0',
        'refresh': '1'
    }
    school = pandas.read_csv(r'paper/paper/school.csv')
    beida = pandas.read_excel(r'paper/paper/北核期刊.xlsx')
    headers = {
        'Accept': '*/*',
        'Accept-Language': 'zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6',
        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'Origin': 'https://webvpn.shmtu.edu.cn',
        'Referer': 'https://webvpn.shmtu.edu.cn/https/77726476706e69737468656265737421fbf952d2243e635930068cb8/kns8s/AdvSearch?classid=WD0FTY92',
